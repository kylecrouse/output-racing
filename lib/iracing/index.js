...
const { getLatestResults, getSeriesResults } = require('./results');
...
class iRacing {
  ...
  getSeriesResults(seasonid) {
    return this.get(getSeriesResults, seasonid);
  }
  ...
  getSeasonStandings(seasonid, custid) {
    return this.get(getSeasonStandings, seasonid, custid);
  }

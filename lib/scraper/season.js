...
async function importSeason(seasonId) {
  ...
  // Update the season with new data or return new season
  return (existing) 
    ? existing.put({ ...season, results, standings, stats }) 
    : league.addSeason(seasonId, { ...season, results, standings, stats });

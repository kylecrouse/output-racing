          ...
          <div className="col-8 col-mx-auto">
            ...
            { props.seasonStats &&
                props.seasonStats.map((season, index) => (
                  <div key={`stats${index}`} style={{ marginTop: "2rem" }}>
                    <h4 className="text-center">{season.name} Stats</h4>
                    <table>
                      <thead>
                        <tr>
                          <th>Starts</th>
            ...
            { props.careerStats &&
              <>
                <h4 className="text-center" style={{ marginTop: "2rem" }}>iRacing Career Stats</h4>
                <table>
                  <thead>
                    <tr>
                      <th>Starts</th>
